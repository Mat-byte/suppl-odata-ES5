		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Suppliers",
									"targetURL": "#mccsuppliersui5-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"mccsuppliersui5-display": {
								"semanticObject": "mccsuppliersui5",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=mcc.suppliersui5",
									"url": sap.ui.require.toUrl("mcc/suppliersui5")
								}
							}
						}
					}
